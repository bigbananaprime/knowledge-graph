...
driver.get('https://search.jd.com/Search?keyword=%E7%94%B7%E8%A3%85&pvid=89d96df96d8044a9a07758afb16243ad&page=137&s=4081&click=0')
""" # 定位关键字+输入关键字
driver.find_element_by_css_selector("#key").send_keys('男装')
# # 定位搜索按钮+点击搜索
...
def get_shop_info():
    f = open('jd男装.csv', mode='a', encoding='utf-8', newline='')
    csv_writer = csv.DictWriter(f, fieldnames=[
        '商品',
        '价格',
        '店铺',
