...
driver.get('https://search.jd.com/Search?keyword=%E5%A5%B3%E8%A3%85&pvid=2652d7d411aa4a5d8c441eccea726e40&page=131&s=3721&click=0')
# 定位关键字+输入关键字
# driver.find_element_by_css_selector("#key").send_keys('女装')
# 定位搜索按钮+点击搜索
